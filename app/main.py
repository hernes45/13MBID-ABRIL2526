...
class PredictionRequest(BaseModel):
    ...
    day_of_week: str = Field(..., description="DIa de la semana del último contacto")
    ...
    cons_price_idx: float = Field(..., description="Indice de precios al consumidor")
    cons_conf_idx: float = Field(..., description="Indice de confianza del consumidor")
